        ...
        {ROOMS.map((r) => {
          ...
          return (
            <li key={r.id}>
              ...
              >
                <span
                  className={`pointer-events-none font-mono text-[10px] uppercase tracking-[0.16em] text-ink-700 opacity-0 transition-opacity duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] group-hover:opacity-100 ${
                    isActive ? "opacity-70" : ""
                  }`}
                >
